...
# short term kernel
s_kernel = 'Matern52' #['ExpQuad', 'RatQuad', 'Matern32'] #, 'Matern52']
...
# short term trend/irregularities ---------------------------------
    ...
    if s_kernel == 'ExpQuad': 
        ...
        cov_s = η_s ** 2 * pm.gp.cov.Matern52(1, ℓ_s) 
...
two_trend_Matern52_dict[pre_script_map_df] = map_df
two_trend_Matern52_dict[pre_script_mse_resutls_df] = mse_resutls_df
two_trend_Matern52_dict[pre_script_df_results] = df_results
two_trend_Matern52_dict[pre_script_df] = df_merged
            

#new_file_name = "/home/polichinel/Documents/Articles/conflict_prediction/data/ViEWS/two_trend_Matern52_allconf_dict.pkl"
new_file_name = '/home/projects/ku_00017/data/generated/currents/two_trend_Matern52_allconf_dict.pkl'
