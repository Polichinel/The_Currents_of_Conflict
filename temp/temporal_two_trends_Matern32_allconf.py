...
two_trend_Matern32_dict[pre_script_map_df] = map_df
two_trend_Matern32_dict[pre_script_mse_resutls_df] = mse_resutls_df
two_trend_Matern32_dict[pre_script_df_results] = df_results
two_trend_Matern32_dict[pre_script_df] = df_merged
            

#new_file_name = "/home/polichinel/Documents/Articles/conflict_prediction/data/ViEWS/two_trend_Matern32_allconf_dict.pkl"
new_file_name = '/home/projects/ku_00017/data/generated/currents/two_trend_Matern32_allconf_dict.pkl'
