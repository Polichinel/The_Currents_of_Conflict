...
gp_dict[pre_script_map_df] = map_df
gp_dict[pre_script_mse_resutls_df] = mse_resutls_df
gp_dict[pre_script_df_results] = df_results
gp_dict[pre_script_df] = df_merged
            

#new_file_name = "/home/polichinel/Documents/Articles/conflict_prediction/data/ViEWS/tt_Rat_Mat32_sb_dict.pkl"
new_file_name = '/home/projects/ku_00017/data/generated/currents/tt_Rat_Mat32_sb_dict.pkl'
output = open(new_file_name, 'wb')
pickle.dump(gp_dict, output)
output.close()
