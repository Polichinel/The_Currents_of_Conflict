...
for i in range(n_rounds):
    ...
    sub0_index_train = np.random.choice(y_train[y_train == 0].index, sub1_index_train.shape[0]*4)
...
print('Pickling..')
new_file_name = '/home/projects/ku_00017/data/generated/currents/rf_hp_US4_9f_df.pkl'
#new_file_name = '/home/simon/Documents/Articles/conflict_prediction/data/computerome/currents/rf_hp_US4_9f_df.pkl'
