...
path = open('/home/projects/ku_00017/data/generated/currents/sce_sample_dict_tt.pkl', 'rb')
sce_sample_dict_tt = pickle.load(path)
path.close()

sce_mp = {'ℓ_log__': np.array(np.log(sce_sample_dict_tt['ℓ'].mean())),
 'η_log__': np.array(np.log(sce_sample_dict_tt['η'].mean())),
 'σ_log__': np.array(np.log(sce_sample_dict_tt['σ'].mean())),
 'ℓ': np.array(sce_sample_dict_tt['ℓ'].mean()),
 'η': np.array(sce_sample_dict_tt['η'].mean()),
 'σ': np.array(sce_sample_dict_tt['σ'].mean())}
