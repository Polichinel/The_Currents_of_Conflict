...
with pm.Model() as model:
    ...
    # GP
    gp = pm.gp.MarginalSparse(mean_func=mean ,cov_func=cov, approx= 'VFE')
...
print('Pickling..')
new_file_name = '/home/projects/ku_00017/data/generated/currents/sce_mp_tt_VFE.pkl'
#new_file_name = '/home/simon/Documents/Articles/conflict_prediction/data/ViEWS/sce_mp_tt.pkl'
